...
|:-:|----------|-------------|------|
| TC1. | Returnera kod som sträng i filen ”example-app/src/code-example.js” |  Skapa ett objekt genom ”let codeAnalyzer = new CodeAnalyzer(’example-app/src/code-example.js’)" | Filen skrivs ut i konsolen som en sträng. |
...
| TC3. | Räkna antalet for-loops i filen ”example-app/src/code-example.js”. | Skapa ett objekt genom ”let codeAnalyzer = new CodeAnalyzer(’example-app/src/code-example.js’)” | Det skrivs ut ” There are 3 for-loops.” i console. |
...
| TC4. | Räkna antalet inline-kommentarer i filen ”example-app/src/code-example.js”. | Skapa ett objekt genom ”let codeAnalyzer = new CodeAnalyzer(’example-app/src/code-example.js’)” | Det skrivs ut ”There are 29 inline-comments.” i console. |
...
| TC5. | Räkna antalet while-loops i filen ”example-app/src/code-example.js”. | Skapa ett objekt genom ”let codeAnalyzer = new CodeAnalyzer(’example-app/src/code-example.js’)” | Det skriv ut ”There are 1 while-loops.” i console. |
...
| TC6. | Räkna antalet returns i filen ”example-app/src/code-example.js”. | Skapa ett objekt genom ”let codeAnalyzer = new CodeAnalyzer(’example-app/src/code-example.js’)” | Det skrivs ut ”There are 7 returns.” i console. |
...
| TC7. | Räkna antalet tecken i filen ”example-app/src/code-example.js”. | Skapa ett objekt genom ”let codeAnalyzer = new CodeAnalyzer(’example-app/src/code-example.js’)” | Det skrivs ut ”There are 17019 characters.” i console. |
...
| TC8. | Räkna antalet variabler i filen ”example-app/src/code-example.js”. | Skapa ett objekt genom ”let codeAnalyzer = new CodeAnalyzer(’example-app/src/code-example.js’)” | Det skriv ut ”There are 30 variables.” i console. |
...
| TC9. | Räkna antalet JSDOC-kommentarer i filen ”example-app/src/code-example.js”. | Skapa ett objekt genom ”let codeAnalyzer = new CodeAnalyzer(’example-app/src/code-example.js’)” | Det skriv ut ”There are 31 jsdoc-comments.” i console. |
...
| TC10. | Läsa filer i foldern "example-app/src/my-memory-game". | Skapa ett objekt genom ”let codeAnalyzer = new CodeAnalyzer()” | Filen skrivs ut som en sträng i console. |
...
| TC11. | Läsa fil från Github från https://github.com/FredrikJurgell/1dv610-L0/blob/master/src/server.js. | Skapa ett objekt genom ”let codeAnalyzer = new CodeAnalyzer(’example-app/src/code-example.js’)” | Det skrivs ut ”There are 139 lines in the code from GitHub.” i console. |
...
| TC12. | Om ingen data skickas med som parameter i linesCounter() | Skapa ett objekt genom ”let codeAnalyzer = new CodeAnalyzer(’example-app/src/code-example.js’)” | Det skrivs ut ”There are 0 lines.” i console. |
